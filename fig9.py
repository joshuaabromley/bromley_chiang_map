...
p1 = 0.53356 ##[0,1] for pierrehumbert, [1,10] for Guillot
p2 = 38.382 ##[20,40]
...
ax[1][0].text(90,1e-4, "$p_1 = {0}$".format(p1), fontsize = textSize)
ax[1][0].text(90,1e-5, "$p_2 = {0}$".format(p2), fontsize = textSize)
ax[1][0].text(90,1e-6, "$p_3 = {0}$".format(p3), fontsize = textSize)
ax[1][0].text(90,1e-7, "$p_4 = {0}$".format(p4), fontsize = textSize)
ax[1][0].text(90,1e-8, "$\lambda = ${0:.4f}".format(lyExp), fontsize = textSize)
ax[1][0].text(10,1e-11*np.exp(30*lyExp), "$\delta \\tau = \delta \\tau_0 e^{\lambda i}$", fontsize = textSize, rotation = 60)
...
ax[0][1].set_xlim(-0.1,1.6)
ax[0][1].set_ylim(-0.1,1.6)
xTicks = np.arange(0,1.55,0.25)
yTicks = np.arange(0,1.55,0.25)
